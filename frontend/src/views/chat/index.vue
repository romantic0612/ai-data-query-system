    ...
    <el-container :loading="loading">
      ...
      >
        <div class="input-wrapper" @click="clickInput">
          ...
          <div class="analysis-mode" @click.stop>
            <el-select
...
const selectedAnalysisMode = ref('raw')
const analysisModeOptions = [
  { label: '原样查询', value: 'raw' },
...
const sendMessage = async (
  ...
  currentRecord.analysis_mode = selectedAnalysisMode.value
